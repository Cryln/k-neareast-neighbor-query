        ...
        <div class="ms-login">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm">
                ...
                <el-form-item prop="password">
                    <el-input type="password" placeholder="密码" v-model="ruleForm.pass" @keyup.enter.native="submitForm('ruleForm')"></el-input>
                </el-form-item>
                ...
                <div class="login-btn">
                    <el-button type="primary" @click="debounce(submitForm,1000)('ruleForm')">登录</el-button>
                </div>
...
<script>
    export default {
        ...
        methods: {
            submitForm(formName) {
                ...
                self.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        self.$http.post('/user/login',self.ruleForm)
                        .then((response) => {
                            ...
                            if (result.code == -2) {
                                ...
                                sessionStorage.setItem('ms_userId',response.data.data.id)
                                console.log(JSON.stringify(self.ruleForm));
                            }
                        }).then((error) => {
                            console.log(error);
            ...
            debounceAjax () {
                this.debounce(this.submitForm,1000);
            }
        }
    }
</script>
